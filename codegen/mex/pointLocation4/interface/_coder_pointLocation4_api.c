 ...
 *
 * _coder_pointLocation4_api.c
 *
 * Code generation for function '_coder_pointLocation4_api'
 *
 */
...
#include "pointLocation4_emxutil.h"
...
static emlrtRTEInfo d_emlrtRTEI = { 1, /* lineNo */
  1,                                   /* colNo */
  "_coder_pointLocation4_api",         /* fName */
  ""                                   /* pName */
};
  ...
  const emlrtMsgIdentifier *msgId))[2]
{
  ...
  void pointLocation4_api(const mxArray * const prhs[3], int32_T nlhs, const
  mxArray *plhs[2])
{
  ...
  pointLocation4(&st, T, P, *qp, &tri, *bc);
...
/* End of code generation (_coder_pointLocation4_api.c) */
