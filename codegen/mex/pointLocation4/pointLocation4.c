 ...
 * pointLocation4.c
 *
 * Code generation for function 'pointLocation4'
 *
 */

/* Include files */
#include "pointLocation4.h"
#include "det.h"
#include "pointLocation4_data.h"
#include "pointLocation4_types.h"
#include "rt_nonfinite.h"
#include "mwmathutil.h"

/* Variable Definitions */
static emlrtRSInfo emlrtRSI = { 46,    /* lineNo */
  "pointLocation4",                    /* fcnName */
  ...
  "ting\\pointLocation_test\\pointLocation4.m"/* pathName */
};
...
static emlrtBCInfo emlrtBCI = { -1,    /* iFirst */
  ...
  10,                                  /* colNo */
  "T",                                 /* aName */
  "pointLocation4",                    /* fName */
  "C:\\Users\\Ryan Fang\\Dropbox\\School\\University\\ECE 494_495 - Engineering Physics Design Project I_II\\Project - External\\Matlab Tes"
  "ting\\pointLocation_test\\pointLocation4.m",/* pName */
  0                                    /* checkKind */
};
...
static emlrtDCInfo b_emlrtDCI = { 68,  /* lineNo */
  11,                                  /* colNo */
  "pointLocation4",                    /* fName */
  "C:\\Users\\Ryan Fang\\Dropbox\\School\\University\\ECE 494_495 - Engineering Physics Design Project I_II\\Project - External\\Matlab Tes"
  "ting\\pointLocation_test\\pointLocation4.m",/* pName */
...
void pointLocation4(const emlrtStack *sp, const emxArray_real_T *T, const
      ...
      if (idx - 1 <= b_T - 1) {
        ...
        if ((p1x - qpx > 50.0) || (p1y - qpy > 50.0)) {
          ...
          if (((int32_T)n2 < 1) || ((int32_T)n2 > P->size[0])) {
            emlrtDynamicBoundsCheckR2012b((int32_T)n2, 1, P->size[0],
              &f_emlrtBCI, sp);
          }
          ...
          if (((int32_T)n3 < 1) || ((int32_T)n3 > P->size[0])) {
            emlrtDynamicBoundsCheckR2012b((int32_T)n3, 1, P->size[0],
              &h_emlrtBCI, sp);
          }
          ...
          if (((p3x - p1x) * r12_idx_1 - (n2 - p1y) * n1 > 0.0) != ((qpx - p1x) *
            ...
            /* just the z component of the cross prod */
            /* check if they are not both same sign */
            if (((p1x - p2x) * r12_idx_1 - (p1y - p2y) * n1 > 0.0) != ((qpx -
                  p2x) * r12_idx_1 - (qpy - p2y) * n1 > 0.0)) {
              guard1 = true;
            } else {
              ...
              /* just the z component of the cross prod */
              /* check if they are not both same sign */
              if (((p2x - p3x) * r12_idx_1 - (p2y - n2) * n1 > 0.0) != ((qpx -
                    p3x) * r12_idx_1 - (qpy - n2) * n1 > 0.0)) {
                guard1 = true;
              } else {
...
/* End of code generation (pointLocation4.c) */
